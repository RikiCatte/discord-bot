...
const { EmbedBuilder, ButtonBuilder, ButtonStyle, ActionRowBuilder, ComponentType, ChatInputCommandInteraction } = require("discord.js");
...
module.exports = async (client, interaction) => {
	...
	// ERRORS FLAG SYSTEM
		...
		if (!interaction.inGuild())
			return await interaction.reply({ content: "You can't use slash commands in DMs!", ephemeral: true });
