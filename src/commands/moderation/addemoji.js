...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        await interaction.reply({ content: '⏲️ | Loading your emoji...', flags: MessageFlags.Ephemeral });
        ...
        setTimeout(() => {
            ...
            interaction.editReply({ content: '', embeds: [embed], flags: MessageFlags.Ephemeral });
        }, 3000)
    }
}